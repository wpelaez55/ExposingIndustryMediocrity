...
public final class PrintHelper {
    ...
    private static final class PrintHelperKitkatImpl implements PrintHelperVersionImpl {
        ...
        class C03221 implements android.support.v4.print.PrintHelperKitkat.OnPrintFinishCallback {
            final /* synthetic */ OnPrintFinishCallback val$callback;

            C03221(OnPrintFinishCallback onPrintFinishCallback) {
        ...
        class C03232 implements android.support.v4.print.PrintHelperKitkat.OnPrintFinishCallback {
            final /* synthetic */ OnPrintFinishCallback val$callback;

            C03232(OnPrintFinishCallback onPrintFinishCallback) {
                this.val$callback = onPrintFinishCallback;
            }
        ...
        public void printBitmap(String jobName, Bitmap bitmap, OnPrintFinishCallback callback) {
            ...
            if (callback != null) {
                delegateCallback = new C03221(callback);
            }
        ...
        public void printBitmap(String jobName, Uri imageFile, OnPrintFinishCallback callback) throws FileNotFoundException {
            android.support.v4.print.PrintHelperKitkat.OnPrintFinishCallback delegateCallback = null;
            if (callback != null) {
                delegateCallback = new C03232(callback);
            }
